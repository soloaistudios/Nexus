...
/*
 * The Trade module can dispatch this event once an order
 * has successfully passed validation and has been added
 * to the active order state.
 *
 * We keep the order data available for the future Orders
 * module without forcing a new screen yet.
 */
window.addEventListener(
  "cap:trade-created",
  (event) => {
