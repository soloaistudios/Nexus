...
/*
   DEBUG MONITORING
   ---------------------------------------------------------
   debug.js is loaded FIRST by index.html.

   This file only imports addDebugEntry() so the router can
   report application-level events and errors.

   Do NOT call initCAPDebug() here because debug.js is already
 ...
 * central in-memory application authentication state.
 */
