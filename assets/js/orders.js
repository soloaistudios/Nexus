...
reservation &&
reservation.asset
? "${formatNumber( reservation.amount )} ${escapeHtml( reservation.asset )}"
: "None";
...
>
  ...
  <div class="orders-card-top">
    ...
    <span class="orders-status orders-status-${escapeHtml(status)}">
      ${escapeHtml(
...
throw new Error(
  `Reserved ${asset} balance is lower than the amount being released.`
);
